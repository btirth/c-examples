...
1.their marks in physics which is an int between 0 and 100
2.their marks in chemistry which is an int number between 0 and 100
3.their marks in mathematics which is an int number between 0 and 100
